...
/**
 * src/cli/sample-store-attributes-as-keys.js
 *
 * Configure the CLI.
 */
'use strict';
...
const sections = [
  {
    ...
    content:
      'Use {bold sample-store-attributes-as-keys} to create  ' +
      'aspect and subject attribute keys.',
  },
  {
    header: 'Synopsis',
    content: [
      '  $ node sample-store-attributes-as-keys',
      '  $ node sample-store-attributes-as-keys [{bold --redisUrl} ' +
        'redis://YOUR_REDIS_CONNECTION_URL]',
      '  $ node sample-store-attributes-as-keys {bold --help}',
    ],
    raw: true,
  },
  {
